...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('mypage')->name('my.')->group(function () {
        ...
        Route::get('orders/book-search',           [\App\Http\Controllers\MyPageController::class, 'orderBookSearch'])->name('orders.book_search');
        ...
        Route::post('orders/{id}/pay-direct-verify',
            [\App\Http\Controllers\PaymentRequestController::class, 'payDirectVerify'])->name('orders.pay_direct_verify');
        ...
        Route::post('cart/recognize', [\App\Http\Controllers\MyPageController::class, 'cartRecognizeAdd'])->name('cart.recognize');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'admin', 'admin.session.timeout'])->group(function () {
        ...
        Route::post('users/{user}/assign-academy-agent', [UserController::class, 'assignAcademyAgent'])->name('users.assign_academy_agent');
