    ...
    public function run(): void
    {
        $templates = [
            ...
            ['user.approval_result', 'alimtalk', '가입 승인/거절 결과',
                "[BookFlow] #{name}님, 가입 신청이 #{result}되었습니다.\n자세한 내용은 앱에서 확인해주세요.",
                ['name','result']],

            ['order.requested', 'alimtalk', '학원 주문 접수(영업자 알림)',
                "[BookFlow] 신규 주문이 접수되었습니다.\n주문번호: #{order_no}\n학원: #{vendor_name}\n총액: #{total_amount}원",
