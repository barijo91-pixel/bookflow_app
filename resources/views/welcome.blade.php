...
{{-- 핵심 기능·주문 흐름 — 랜딩에서 숨김 (2026-08-24).
     내용은 partials/landing/ 에 그대로 있고, 아래 두 줄 주석만 풀면 되살아난다.
@include('partials.landing.features')
@include('partials.landing.order_flow')
--}}
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card h-100 border-0 shadow-sm">
                            @if($b->cover_path)
                                ...
                                <div class="align-items-center justify-content-center bg-light" style="height:190px; display:none;"><i class="bi bi-book" style="font-size:2.6rem; color:#cbd3dd;"></i></div>
                            @else
