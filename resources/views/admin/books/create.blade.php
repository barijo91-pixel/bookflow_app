        ...
        <div class="card-body">
                ...
                <div class="col-md-10">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="subtitle" id="subtitle_input" class="form-control" value="{{ old('subtitle') }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="author" id="author_input" class="form-control" value="{{ old('author') }}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small text-muted">출간일</label>
                            <input type="date" name="pub_date" id="pub_date_input" class="form-control" value="{{ old('pub_date') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="default_discount_rate" class="form-control text-end" value="{{ old('default_discount_rate', 0) }}">
                </div>
                <div class="col-md-3">
