                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="min-w-0">
                                            <strong>{{ $b->title }}</strong>@if($b->subtitle)<span class="text-muted"> — {{ $b->subtitle }}</span>@endif
                                            @if($b->publisher_name)<div class="text-muted small">{{ $b->publisher_name }}</div>@endif
                                        </div>
                                    </div>
                                </td>
